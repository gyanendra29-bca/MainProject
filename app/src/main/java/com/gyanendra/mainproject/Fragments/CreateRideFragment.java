...
public class CreateRideFragment extends Fragment {
    ...
    EditText riderNameEditTxt, sourceAddressEditTxt, destinationAddressEditTxt, totalPassengersEditTxt, rideDateEditTxt, rideTimeEditTxt, ridePriceEditTxt, phoneNumberEditTxt,VehicleNumberTxt;
    Button createRide;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        VehicleNumberTxt=(EditText)view.findViewById(R.id.VehicleNumberEdit);
        ...
        createRide.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String VehicleNumber = VehicleNumberTxt.getText().toString().trim();

                //Shows the below toast message if eny EditText field is empty
                if (riderName.isEmpty() || sourceAddress.isEmpty() || destinationAddress.isEmpty() || totalPassengers.isEmpty() || rideDate.isEmpty() || rideTime.isEmpty() || ridePrice.isEmpty() || phoneNumber.isEmpty() || VehicleNumber.isEmpty()) {
                    ...
                    AddDataToFirebase(riderName, sourceAddress, destinationAddress, totalPassengers, rideDate, rideTime, ridePrice, phoneNumber,VehicleNumber);
                }
    ...
    private void AddDataToFirebase(String riderName, String sourceAddress, String destinationAddress, String totalPassengers, String rideDate, String rideTime, String ridePrice, String phoneNumber,String VehicleNumber) {
        ...
        user_details.put("Vehicle Number", VehicleNumber);
