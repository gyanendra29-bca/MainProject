        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ((TextUtils.isEmpty(Email))){
                    ...
                    Toast.makeText(log_in.this, "Enter The Email", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(log_in.this, "Password Needs To Be Longer Then Six Characters", Toast.LENGTH_SHORT).show();
                }else {
                    auth.signInWithEmailAndPassword(Email,pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                progressDialog.show();
                                try {
                                    Intent intent = new Intent(log_in.this ,chatdashboard .class);
                                    startActivity(intent);
                                    finish();
                                }catch (Exception e){
