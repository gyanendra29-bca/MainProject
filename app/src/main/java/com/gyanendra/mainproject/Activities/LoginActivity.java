...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions signInOptions = new GoogleSignInOptions
                ...
                .requestIdToken("653619089129-sfshpsbout26sbt1i9i0efs1nc2c82lm.apps.googleusercontent.com")
                .requestEmail()
                .build();

        mSignInClient = getClient(getApplicationContext(), signInOptions);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 100) {
            Task<GoogleSignInAccount> googleSignInAccountTask = getSignedInAccountFromIntent(data);
