package com.gyanendra.mainproject.Adapter;
...
public class Adapter extends FirebaseRecyclerAdapter<Model, Adapter.Viewholder> {
    ...
    protected void onBindViewHolder(@NonNull Viewholder holder, int position, @NonNull Model model) {
        ...
        holder.riderVehicleNumber.setText("Rider Vehicle: " + model.getVehicleNumber());
    ...
    public Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_ride_details, parent, false);
    ...
    class Viewholder extends RecyclerView.ViewHolder {
        ...
        TextView riderName, sourceAddress, destinationAddress, totalPassengers, rideDate, rideTime, ridePrice, riderPhoneNumber,riderVehicleNumber;
        Button bookRide;
        ...
        public Viewholder(@NonNull View itemView) {
            ...
            riderVehicleNumber = (TextView) itemView.findViewById(R.id.RiderVehicleNumber);
