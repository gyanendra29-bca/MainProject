...
import com.gyanendra.mainproject.AboutUs;
import com.gyanendra.mainproject.Activities.EditDetailsActivity;
import com.gyanendra.mainproject.Activities.StartingActivity;
import com.gyanendra.mainproject.Activity_help;
import com.gyanendra.mainproject.ConectToChat.log_in;
...
public class ProfileFragment extends Fragment {
    ...
    Button signOutBtn, editDetailsBtn,btn1,btn2,btn3;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getContext(), Activity_help.class);
                startActivity(intent);
            }
        });
